# 2016-02-02 TUE
# Make meme input fasta file (FIMO 1kb q-value<0.01)
# Edit Fimo for meme input files (fasta format) v1.1
import os.path
def fimo2meme(file_NAME,out_dir,qv_thr=0.05,debug=False):
    ...
    for i in range(0,len(pttn_li)):
        ...
        with open(dir_PATH+'\\'+out_dir+'\\'+pttn_li[i]+'_4689.txt','w') as f:
            f.write(fa)
        if debug==True: print('file written done.')
    print('3. file written process done.\n')
    return()
# %%
fimo2meme('\\160513_intergenic_SCPD\\fimo_scpd.tsv','160513_intergenic_qv_5_logo',qv_thr=0.05)
fimo2meme('\\160513_intergenic_SwissRegulon\\fimo_swissreg.tsv','160513_intergenic_qv_5_logo',qv_thr=0.05)
fimo2meme('\\160513_intergenic_UniPROBE\\fimo_uniprobe.tsv','160513_intergenic_qval5_logo',qv_thr=0.05)
fimo2meme('\\160513_intergenic_YEASTRACT\\fimo_yeastract.tsv','160513_intergenic_qval5_logo',qv_thr=0.05)